...
- **Trip overview** — a read-only editorial summary of the whole trip, not a navigation menu: an opening line ("3 days across London and Edinburgh, from Jul 9 to Jul 11"), then one card per city with a hero photo, weather, a nights count, and a plain-English sentence naming every place being visited there ("Visiting Heathrow Airport, Dishoom Covent Garden, British Museum, Big Ben, and The Ivy."). The only way out is the header's "Back to day" toggle.
