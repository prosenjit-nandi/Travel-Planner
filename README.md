...
- **Trip overview** — a condensed view grouping consecutive same-city days into legs (e.g. "London, Jul 24–26"), each with a city photo, weather for the leg's first day, a nights count, and a category breakdown (e.g. "Excursion 3, Dining 2"), so a multi-city trip's shape is visible at a glance; tap a leg to jump to its first day.
